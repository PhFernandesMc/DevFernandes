...
const Sidebar = () => {
  const [instagramActive, setInstagramActive] = useState<boolean>(false);
  const [linkedinActive, setLinkedinActive] = useState<boolean>(false);
  const [githubActive, setGithubActive] = useState<boolean>(false);

  return (
    <div className="fixed left-5 bottom-5 w-15 h-40">
      <ul className="flex h-full flex-col justify-center gap-1">
        <a href="https://github.com/PhFernandesMc" target="_blank">
          <li
            className="text-#000 hover:cursor-pointer"
            onMouseOver={() => {
                ...
                >
                  ...
                  >
                    ...
                    <rect
                      id="mask"
                      stroke-width="1"
                      className={`transition-all ease-out duration-300 ${githubActive ? "fill-white" : "fill-main"}`}
                      x="-1"
                      y="-1"
                      width="71"
                      height="71"
                    ...
                    <path
                      ...
                      id="Shape"
                      className={`transition-all ease-out duration-300 ${githubActive ? "fill-black" : "fill-[#2E2E31]"}`}
                    >
                      {" "}
                    </path>{" "}
                  </g>{" "}
            ...
            >
              ...
              <g id="SVGRepo_iconCarrier">
                ...
                <path
                  ...
                  className={`${
                    instagramActive ? "fill-[#FFF]" : "fill-[#2E2E31]"
                ...
                <defs>
                  ...
                  >
                    ...
                    <stop
                      ...
                      stop-color={instagramActive ? "#B13589" : "#234F49"}
                    ></stop>
                    <stop
                      className="transition-all ease-in duration-300"
                      offset="0.79309"
                      stop-color={instagramActive ? "#C62F94" : "#234F49"}
                    ></stop>{" "}
                    <stop
                      className="transition-all ease-in duration-300"
                      offset="1"
                      stop-color={instagramActive ? "#8A3AC8" : "#234F49"}
                    ></stop>{" "}
                  </radialGradient>{" "}
                  <radialGradient
                  ...
                  >
                    ...
                    <stop
                      className="transition-all ease-in duration-300"
                      stop-color={instagramActive ? "#E0E8B7" : "#234F49"}
                    ></stop>
                    <stop
                      className="transition-all ease-in duration-300"
                      offset="0.444662"
                      stop-color={instagramActive ? "#FB8A2E" : "#234F49"}
                    ></stop>{" "}
                    <stop
                      className="transition-all ease-in duration-300"
                      offset="0.71474"
                      stop-color={instagramActive ? "#E2425C" : "#234F49"}
                    ></stop>{" "}
                    <stop
                      className="transition-all ease-in duration-300"
                      offset="1"
                  ...
                  >
                    ...
                    <stop
                      className="transition-all ease-in duration-300"
                      offset="0.156701"
                      stop-color={instagramActive ? "#406ADC" : "#234F49"}
                    ></stop>{" "}
                    <stop
                      className="transition-all ease-in duration-300"
                      offset="0.467799"
                      stop-color={instagramActive ? "#6A45BE" : "#234F49"}
                    ></stop>{" "}
                    <stop
                      className="transition-all ease-in duration-300"
                      offset="1"
        ...
        >
          ...
          >
            <div
              className={`absolute top-1 left-2 w-10 h-10 ${
                linkedinActive ? "bg-white" : "bg-[#2E2E31]"
              } -z-1 transition-all ease-in duration-300`}
            ></div>
            <svg
              className="z-10"
              width="60px"
              ...
              fill="none"
            >
              <g className="z-10" id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g
                className="z-10"
                id="SVGRepo_tracerCarrier"
                stroke-linecap="round"
                stroke-linejoin="round"
              ></g>
              <g className="z-10" id="SVGRepo_iconCarrier">
                <path
                  className={`z-10 ${
                    linkedinActive ? "fill-[#0A66C2]" : "fill-main"
                  } transition-all ease-in duration-300`}
